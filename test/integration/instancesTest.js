...
describe('Instance', function () {
  ...
  it('should be able to set global config via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(instance => {
  ...
  it('should be able to get global config via model instance', () => {
  ...
  describe('#please()', () => {
    it('should be able to list instances', () => {
    ...
    it('should be able to set global config', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(instance => {
    ...
    it('should be able to get global config', () => {
      let tempInstance = null
    ...
    it('should be able to get or create instance (CREATE)', () => {
    ...
    it('should be able to get or create instance (GET)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(instance => {
          should(instance).be.an.Object()
    ...
    it.skip('should be able to rename an instance', () => {
    ...
    it('should be able to update or create instance (UPDATE)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(instance => {
          should(instance).be.an.Object()
    ...
    it('should be able to update or create instance (CREATE)', () => {
    ...
    it('should be able to get first instance (SUCCESS)', () => {
      return Model.please().bulkCreate(objects)
        .then(cleaner.mark)
        .then(() => {
    ...
    it.skip('should be able to change ordering', () => {
      ...
      return Model.please().bulkCreate(objects)
        ...
        .then(instances => {
          should(instances).be.an.Array().with.length(2)
          return Model.please().ordering('asc')
        })
        .then(instances => {
          should(instances).be.an.Array().with.length(2)
