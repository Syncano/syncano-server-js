...
describe('GCMDevice', function () {
  ...
  describe('#please()', () => {
    ...
    it('should be able to update or create a Model (UPDATE)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(gcm => {
          should(gcm).be.an.Object()
    ...
    it('should be able to update or create a Model (CREATE)', () => {
    ...
    it('should be able to send message directly from device', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(() => {
    ...
    it('should be able to send messages directly from device', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(() => {
          return connection.GCMConfig.please().update({instanceName}, {
