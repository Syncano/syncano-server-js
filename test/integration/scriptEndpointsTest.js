...
describe('ScriptEndpoint', function () {
  ...
  it('should be able to run script via model instance', () => {
    return Model(ModelData).save()
      .then(cleaner.mark)
      .then(scriptendpoint => {
        should(scriptendpoint).be.a.Object()
  ...
  it('should be able to run script via model instance with cacke_key', () => {
    return Model(ModelData).save()
      .then(cleaner.mark)
      .then(scriptendpoint => {
        should(scriptendpoint).be.a.Object()
  ...
  describe('#please()', () => {
    ...
    it('should be able to run script with cache_key', () => {
      return Model(ModelData).save()
        .then(cleaner.mark)
        .then(scriptendpoint => {
          should(scriptendpoint).be.a.Object()
