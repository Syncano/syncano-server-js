...
describe('BatchManager', function () {
  ...
  it('should validate objects added via the #addObjects() method', () => {
    should(() => {
  ...
  it('should validate objects added via the #addSingleObject() method', () => {
    should(() => {
      Manager.addSingleObject({ something: 'thing' }, 'save')
    }).throw(/not a valid object/)
  })

  it('should validate max number of objects added to batch', () => {
    should(() => {
  ...
  it('should be able to batch create objects', () => {
  ...
  it('should be able to batch update objects', () => {
  ...
  it('should be able to batch different actions', () => {
    const mixedObjects = [
  ...
  it('should be able to batch delete objects', () => {
