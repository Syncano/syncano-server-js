...
describe('DataObject', function () {
  ...
  it('should validate "channel_room"', () => {
  ...
  it('should be able to save with an object field via model instance', () => {
  ...
  it('should be able to save with an array field via model instance', () => {
  ...
  it('should be able to add array elements via model instance', () => {
    return Model({ instanceName, className: arrayClass.name, name: 'John', numbers: [1, 2, 3, 4, 5]}).save()
      .then(cleaner.mark)
      .then(object => {
        should(object).be.an.Object()
  ...
  it('should be able to remove array elements via model instance', () => {
    return Model({ instanceName, className: arrayClass.name, name: 'John', numbers: [1, 2, 3, 4, 5]}).save()
      .then(cleaner.mark)
      .then(object => {
        should(object).be.an.Object()
  ...
  it('should be able to add unique array elements via model instance', () => {
    return Model({ instanceName, className: arrayClass.name, name: 'John', numbers: [1, 2, 3, 4, 5]}).save()
      .then(cleaner.mark)
      .then(object => {
        should(object).be.an.Object()
  ...
  it('should be able to save with a geopoint via model instance', () => {
  ...
  it('should be able to update geopoint via model instance', () => {
    return Model(location1).save()
      .then(cleaner.mark)
      .then(dataobj => {
        should(dataobj).have.property('location_name').which.is.String().equal(location1.location_name)
  ...
  it('should be able to save with relation via model instance', () => {
    let authorId = null
  ...
  it('should be able to add relation via model instance', () => {
    let authorIds = null
  ...
  it('should be able to remove relation via model instance', () => {
    let authorIds = null
  ...
  it('should be able to get related objects via model instance', () => {
    let authorIds = null
  ...
  it('should be able to increment a model field', () => {
    return Model(dataObj).save()
      .then(cleaner.mark)
      .then(dataobj => {
        should(dataobj).have.property('instanceName').which.is.String().equal(data.instanceName)
  ...
  describe('#please()', () => {
    ...
    it('should be able to fetch all objects', done => {
    ...
    it('should be able to fetch a specified number of pages', done => {
      let currentPage = 0
      return Model.please().bulkCreate(objects3)
        .then(cleaner.mark)
        .then(() => {
    ...
    it('should be able to save with an array field', () => {
    ...
    it('should be able to add array elements', () => {
      return Model.please().create({ instanceName, className: arrayClass.name, name: 'John', numbers: [1, 2, 3, 4, 5]})
        .then(cleaner.mark)
        .then(object => {
          should(object).be.an.Object()
    ...
    it('should be able to remove array elements', () => {
      return Model.please().create({ instanceName, className: arrayClass.name, name: 'John', numbers: [1, 2, 3, 4, 5]})
        .then(cleaner.mark)
        .then(object => {
          should(object).be.an.Object()
    ...
    it('should be able to add unique array elements', () => {
      return Model.please().create({ instanceName, className: arrayClass.name, name: 'John', numbers: [1, 2, 3, 4, 5]})
        .then(cleaner.mark)
        .then(object => {
          should(object).be.an.Object()
    ...
    it('should be able to create a model with a relation field', () => {
      let authorId = null
    ...
    it('should be able to add relation', () => {
      let authorIds = null
    ...
    it('should be able to filter objects by relation using #is()', () => {
      let authorIds = null
    ...
    it('should be able to filter objects by relation using #contains()', () => {
      let authorIds = null
    ...
    it('should be able to remove relation', () => {
      let authorIds = null
    ...
    it('should be able to list objects near coordinates', () => {
      return Model.please().create(location1)
        ...
        .then(objects => {
          ...
          should(objects[0].coordinates).have.property('latitude').which.is.Number().equal(location1.coordinates.latitude)
          should(objects[0].coordinates).have.property('longitude').which.is.Number().equal(location1.coordinates.longitude)
        })
    })

    it('should be able to list objects near coordinates within a distance in kilometers', () => {
      return Model.please().create(location1)
        .then(cleaner.mark)
        .then(() => {
    ...
    it('should be able to list objects near coordinates within a distance in miles', () => {
      return Model.please().create(location1)
        .then(cleaner.mark)
        .then(() => {
    ...
    it('should be able to create a Model with a geopoint', () => {
      return Model.please().create(location1)
        .then(cleaner.mark)
        .then(dataobj => {
          should(dataobj).be.a.Object()
    ...
    it('should be able to update a Model with a geopoint', () => {
      return Model.please().create(location1)
        .then(cleaner.mark)
        .then(dataobject => {
          should(dataobject).be.a.Object()
    ...
    it('should be able to increment a field', () => {
      return Model.please().create(dataObj)
        .then(cleaner.mark)
        .then(dataobject => {
          should(dataobject).be.an.Object()
    ...
    it('should be able to get first Model', () => {
    ...
    it('should be able to get specific model fields', () => {
      let objId = null
    ...
    it('should be able to change ordering by field', () => {
      let asc = null
    ...
    it('should be able to filter model by field', () => {
      return Model.please().bulkCreate(objects)
         .then(cleaner.mark)
         .then(dataobjects => {
           should(dataobjects).be.an.Array().with.length(2)
    ...
    it('should send correct query when using pagination with filtering', () => {
      return Model.please().bulkCreate(objects2)
        .then(cleaner.mark)
        .then(dataobjects => {
          should(dataobjects).be.an.Array().with.length(2)
    ...
    it('should be able to get template response', () => {
      return Model.please().create(dataObj)
      .then(cleaner.mark)
      .then(dataobject => {
        should(dataobject).have.property('instanceName').which.is.String().equal(instanceName)
