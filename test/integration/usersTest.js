...
describe('User', function () {
  ...
  it('should be able to reset key via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(object => {
        should(object).be.a.Object()
  ...
  it('should be able to get groups via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(user => {
  ...
  it.skip('should be able to add group via model instance', () => {
    let groupId = null
  ...
  it.skip('should be able to get group via model instance', () => {
    let groupId = null
    let tempUser = null
  ...
  it.skip('should be able to delete group via model instance', () => {
    let groupId = null
    let tempUser = null
  ...
  describe('#please()', () => {
    ...
    it('should be able to list objects as template', () => {
    ...
    it('should be able to delete an object', () => {
      return Model(data).save()
        .then(object => {
          should(object).be.a.Object()
          should(object).have.property('instanceName').which.is.String().equal(instanceName)
    ...
    it.skip('should be able to update an object (userKey & apiKey)', () => {
      let accountKey = null
      let apiKey = null
    ...
    it('should be able to reset key in object', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(object => {
          should(object).be.a.Object()
    ...
    it('should be able get currently logged in user details', () => {
    ...
    it('should be able to do a social login', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(object => {
          should(object).be.a.Object()
    ...
    it('should be able to update schema', () => {
    ...
    it.skip('should be able to get groups', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(object => {
    ...
    it.skip('should be able to add group', () => {
      let groupId = null
      let userId = null
    ...
    it.skip('should be able to delete group', () => {
      let groupId = null
      let userId = null
    ...
    it.skip('should be able to get group', () => {
      let groupId = null
      let tempUser = null
    ...
    it.skip('should be able to get an object (userKey & apiKey)', () => {
      let accountKey = null
      let apiKey = null
