...
describe('Instance Invitation', function () {
  ...
  before(() => {
    ...
    objects = [
      Model({email, role: 'read', instanceName}),
  ...
  it('should require "instanceName"', () => {
    should(Model({email}).save()).be.rejectedWith(/instanceName/)
  })
  ...
  it('should be able to resend via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(inv => {
        should(inv).be.an.Object()
  ...
  describe('#please()', () => {
    ...
    it('should be able to resend invitation', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(inv => {
          should(inv).be.an.Object()
