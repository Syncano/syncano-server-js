...
describe('Template', function () {
  ...
  it('should be able to render a template via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(tpl => {
        should(tpl).be.a.Object()
  ...
  it('should be able to rename a template via model instance', () => {
    return Model(data).save()
      .then(tpl => {
        should(tpl).be.a.Object()
        should(tpl).have.property('name').which.is.String().equal(data.name)
  ...
  describe('#please()', () => {
    it('should be able to list templates', () => {
    ...
    it('should be able to get a template', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(tpl => {
          should(tpl).be.a.Object()
    ...
    it('should be able to get or create a template (CREATE)', () => {
    ...
    it('should be able to get or create a template (GET)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(tpl => {
          should(tpl).be.an.Object()
    ...
    it('should be able to rename a template', () => {
      return Model.please().create(data)
        .then(tpl => {
          should(tpl).be.an.Object()
          should(tpl).have.property('name').which.is.String().equal(templateName)
    ...
    it('should be able to update or create template (UPDATE)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(tpl => {
          should(tpl).be.an.Object()
    ...
    it('should be able to update or create template (CREATE)', () => {
    ...
    it('should be able to get first template (SUCCESS)', () => {
      return Model.please().bulkCreate(objects)
        .then(cleaner.mark)
        .then(() => {
