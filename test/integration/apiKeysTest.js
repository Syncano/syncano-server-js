...
describe('ApiKey', function () {
  ...
  describe('#please()', () => {
    it('should be able to list api keys', () => {
    ...
    it('should be able to bulk create a api keys', () => {
    ...
    it('should be able to get an api key', () => {
      let keyId = null
    ...
    it('should be able to update an api key', () => {
    ...
    it('should be able to reset an api key', () => {
      let apiKey
      let keyId
      return Model.please().create({instanceName, description: 'test'})
        .then(cleaner.mark)
    ...
    it('should be able to get first api key', () => {
