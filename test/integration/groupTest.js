...
describe('Group', function () {
  ...
  it('should be able to list users via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(object => {
        return object.users()
  ...
  it('should be able to add user via model instance', () => {
    let group = null
  ...
  it('should be able to get user details via model instance', () => {
    let group = null
  ...
  it('should be able to delete user via model instance', () => {
    let group = null
    let user_id = null
  ...
  describe('#please()', () => {
    ...
    it('should be able to get or create an object (CREATE)', () => {
    ...
    it('should be able to get or create an object (GET)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(object => {
          should(object).be.a.Object()
    ...
    it('should be able to update or create an object (UPDATE)', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(object => {
          should(object).be.a.Object()
    ...
    it('should be able to update or create an object (CREATE)', () => {
