...
describe('Script', function () {
  ...
  it('should be able to run via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(script => {
        should(script).have.property('instanceName').which.is.String().equal(data.instanceName)
  ...
  it('should be able to get runtimes via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(script => {
        should(script).have.property('instanceName').which.is.String().equal(data.instanceName)
  ...
  describe('#please()', () => {
    ...
    it('should be able to get a script', () => {
      let scriptId = null
    ...
    it('should be able to get first script', () => {
      return Model.please().bulkCreate(objects)
        .then(cleaner.mark)
        .then(() => {
    ...
    it('should be able to run a script', () => {
      let scriptId = null
    ...
    it('should be able to get runtimes', () => {
      return Model(data).save()
        .then(cleaner.mark)
        .then(script => {
          should(script).have.property('instanceName').which.is.String().equal(data.instanceName)
