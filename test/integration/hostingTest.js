...
describe('Hosting', function () {
  ...
  it('should be able to set default via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(hosting => {
        should(hosting).be.an.Object()
  ...
  it('should be able to list files via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(hosting => {
        should(hosting).be.an.Object()
  ...
  it('should be able to upload file via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(hosting => {
        should(hosting).be.an.Object()
  ...
  it('should be able to upload multiple files via model instance', () => {
    return Model(data).save()
      .then(cleaner.mark)
      .then(hosting => {
        should(hosting).be.an.Object()
  ...
  it('should be able to update file via model instance', () => {
  ...
  it('should be able to get file details via model instance', () => {
    let tempHosting = null
    return Model(data).save()
      .then(cleaner.mark)
      .then(hosting => {
  ...
  it('should be able to delete file via model instance', () => {
    let tempHosting = null
    return Model(data).save()
      .then(cleaner.mark)
      .then(hosting => {
  ...
  describe('#please()', () => {
    ...
    it('should be able to set default', () => {
      return Model.please().create(data)
        .then(cleaner.mark)
        .then(hosting => {
          should(hosting).be.an.Object()
    ...
    it('should be able to update file', () => {
      let fileSize = null
      let tempHosting = null
      return Model(data).save()
        .then(cleaner.mark)
    ...
    it('should be able to get file details', () => {
      return Model(data).save()
        .then(cleaner.mark)
        .then(hosting => {
          should(hosting).be.an.Object()
