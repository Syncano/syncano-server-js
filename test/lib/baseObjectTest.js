...
describe('Syncano', () => {
  ...
  describe('#getAccountKey()', () => {
    it('should allow to get account key', () => {
  ...
  describe('#getBaseUrl()', () => {
    it('should allow to get base url', () => {
  ...
  describe('#setInstanceName()', () => {
    it('should allow to set instance name', () => {
  ...
  describe('#getInstanceName()', () => {
    it('should allow to get instance name', () => {
  ...
  describe('#getUserKey()', () => {
    it('should allow to get user key', () => {
  ...
  describe('#getSocialToken()', () => {
    it('should allow to get social token', () => {
