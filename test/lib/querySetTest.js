...
describe('QuerySet', () => {
  ...
  describe('#serialize()', () => {
    it('should serialize list', () => {
      ...
      const response = {objects: [{x: 1}, {x: 2}]}
  ...
  describe('#request()', () => {
    ...
    it('should reject request error', () => {
  ...
  describe('#then()', () => {
    it('should call request method', () => {
      const spy = sinon.spy(qs, 'request')
    ...
    it('should return Promise with then callback configured', () => {
      should(qs.then(() => {})).be.Promise()
    })
  })
  ...
  describe('#getOrCreate()', () => {
    ...
    it('should call create if get fails', () => {
  ...
  describe('#list()', () => {
    it('should return "this" and set properties and query', () => {
  ...
  describe('#delete()', () => {
    it('should return "this" and set properties', () => {
      qs.properties = {pa: 1, pb: 2}
  ...
  describe('#updateOrCreate()', () => {
    ...
    it('should call create if update fails', () => {
  ...
  describe('#pageSize()', () => {
    it('should return "this" and set pageSize', () => {
  ...
  describe('#ordering()', () => {
    it('should return "this" and set ordering', () => {
  ...
  describe('#raw()', () => {
    it('should disable serialization and return "this"', () => {
