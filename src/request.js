...
const Request = stampit().compose(ConfigMixin, Logger)
  ...
  .methods({
    ...
    * @param {String} path path part of URL e.g: /v2/instances/
    * @returns {String}
    ...
    * @param {String} path e.g /v2/instances/
    ...
    */
    makeRequest(methodName, path, requestOptions) {
      ...
      let request = handler((_.isEmpty(files) ? method : 'POST'), this.buildUrl(path))
    ...
    */
    setRequestHandler(handler) {
      const _request = this.fixed.refs._request || {}
